%
% This script performs triangulation twice, once with the correct
% focal length and a second time with a focal length
% for the left camera that is 10% larger. 
% Then It plots the two recovered surfaces.
...
% ============================================================
% PLOT WITH THE "CORRECT" FOCAL LENGTH
...
% ============================================================
% PLOT WITH A DIFFERENT FOCAL LENGTH

camL.f = 110; % 10 percent larger
famR.f = 100;
